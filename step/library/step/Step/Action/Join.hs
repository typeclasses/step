...
instance ActionJoin AtomicMove Query      where actionJoin = Coerced.join
...
instance ActionJoin Move       Sure       where actionJoin = Coerced.join

instance ActionJoin Query      Any        where actionJoin = Coerced.join
instance ActionJoin Query      Atom       where actionJoin = Coerced.join
instance ActionJoin Query      AtomicMove where actionJoin = Coerced.join
...
instance ActionJoin Query      Sure       where actionJoin = Coerced.join

instance ActionJoin Sure       Any        where actionJoin = Coerced.join
instance ActionJoin Sure       Atom       where actionJoin = Coerced.join
instance ActionJoin Sure       AtomicMove where actionJoin = Coerced.join
instance ActionJoin Sure       Move       where actionJoin = Coerced.join
instance ActionJoin Sure       Query      where actionJoin = Coerced.join
