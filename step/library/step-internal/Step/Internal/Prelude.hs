...
import BasePrelude as X (Bool (..), Semigroup ((<>)), Monoid (mempty), Ordering (..), Maybe (..), Either (..), Eq, (==), (/=), Ord (compare), Show, Num, (+), (-), Integer, Int, fromIntegral, ($), (.), (<$>), error, id, Monad (return, (>>=)), (=<<), Char, elem, (&&), (||), (<), (>), (<=), (>=), Functor, Applicative (pure), fmap, IO, (<*), (*>), (<*>), Integral, not, quotRem)
