...
spec = describe "Document parsing" do
    ...
    describe "p = char, char, char" do
        ...
        let p :: Parser Text 'Committing1 Identity (Char, Char, Char) =
              char P.>>= \a -> char P.>>= \b -> char P.>>= \c -> P.return (a, b, c)
    ...
    --         let p = appEndo (times n (Endo (char P.*>))) position
