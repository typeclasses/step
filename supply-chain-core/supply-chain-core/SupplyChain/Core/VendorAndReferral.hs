module SupplyChain.Core.VendorAndReferral (Vendor (..),
...
pattern (:>) :: product -> Vendor up down action -> Referral up down action product
pattern product :> next = Referral product next
